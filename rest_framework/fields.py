...
class EmailField(CharField):
    ...
    def __init__(self, **kwargs):
        ...
        validator = EmailValidator(message=self.error_messages['invalid'],whitelist=settings.USER_EMAIL_ALLOWED_DOMAINS)
        self.validators.append(validator)
        self.validators.append(self.validate_user_email_allowed_domains)
